    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex flex-wrap gap-3 items-end">
          {/* Agent username */}
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">Agent Username</label>
            <input
              type="text"
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-sm text-gray-500">Loading audit log...</span>
            </div>
          </div>
        ) : error ? (
          ...
          <div className="p-12 text-center">
            <p className="text-sm font-medium text-gray-500">No audit log entries found</p>
                ...
                {data?.items.map((entry) => (
                  <tr key={entry.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600 max-w-xs truncate">
                      {entry.action_value ?? <span className="text-gray-300">—</span>}
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={page <= 1}
            className="px-3 py-1.5 text-sm font-medium rounded-md border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            Previous
          </button>
